export default {
  ...
  // User messages
  getUserFailure: 'An error occured, unable to show user.',
  indexUserFailure: 'An error occured, unable to get user list.',
  getUserArtFailure: 'An error occured, unable to show this user\'s image'
}
